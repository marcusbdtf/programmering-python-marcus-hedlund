...
class Vector:
    ...
    def __init__(self, *numbers: float) -> None: # star means positional meter
        #print(numbers)
        for number in numbers:
            if not isinstance(number, (float,int)):
                raise TypeError(f"{number} is must be float or int")
...
# v1 = (1,1), v2 = (1,1,14,15,252,56,2,7) (examples)